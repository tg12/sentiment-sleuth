...
def parabolic_sar(stock_data):
    ...
    # remove any rows with NaN values and 0 values and reset index
...
def main():
    ...
    """
    # read in backtest_prices.csv
    df = pd.read_csv('backtest_prices.csv')
    ...
    plot_signals(signals_data, "Nat Gas Futures")
